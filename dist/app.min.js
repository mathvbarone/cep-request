...
"use strict";$(document).ready(function(){var o=function(o){$.ajax({url:"https://viacep.com.br/ws/"+o+"/json/",dataType:"json",error:n,success:e})},e=function(o){$.each(o,function(o,e){$("#"+o).val(e)})},n=function(){console.log("O servidor retornou com um erro!")};$("#cep").on("input",function(o){this.value=this.value.replace(/\D/g,"")}).on("focusout",function(){var e=this.value;e.length<8?$(this).addClass("error").focus():($(this).removeClass("error"),o(e))})});